          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              >
                ...
                <mask id="react-mask-304" fill="white">
                  <use xlinkHref="#react-path-303"></use>
                </mask>
                <use
                  id="Hoodie"
                  fill="#B7C1DB"
                  fillRule="evenodd"
                  xlinkHref="#react-path-303"
                ></use>
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-304)"
                  fillRule="evenodd"
                  fill="#3C4F5C"
                >
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-229" fill="white">
                  <use xlinkHref="#react-path-231"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-229)">
